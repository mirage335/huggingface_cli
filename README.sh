...
_t 'Copyright (C) 2025 mirage335
See the end of the file for license conditions.
See license.txt for huggingface_cli license conditions.
...
_paragraph_begin
_t '
This file is part of huggingface_cli.

huggingface_cli is free software: you can redistribute it and/or modify
it under the terms of the GNU Affero General Public License as published by
the Free Software Foundation, either version 3 of the License, or
(at your option) any later version.

huggingface_cli is distributed in the hope that it will be useful,
but WITHOUT ANY WARRANTY; without even the implied warranty of
MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
GNU Affero General Public License for more details.

You should have received a copy of the GNU Affero General Public License
along with huggingface_cli.  If not, see &lt;http://www.gnu.org/licenses/&gt;.
'
_paragraph_end
_t '
